...
const AdminDashboard = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      {/* Sidebar */}
      <div className={`${sidebarCollapsed ? 'w-16' : 'w-[260px]'} bg-white border-r border-gray-200 transition-all duration-300 flex flex-col shadow-lg flex-shrink-0`}>
        {/* Logo */}
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            {!sidebarCollapsed && (
              <div>
                <span className="text-xl font-bold text-gray-800">MediMeal</span>
          ...
          <div className="space-y-1">
            <button 
              ...
              className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors ${
                activeSection === 'dashboard' ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-500' : 'text-gray-600 hover:bg-gray-50'
              }`}
            >
            ...
            <button 
              ...
              className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors ${
                activeSection === 'users' ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-500' : 'text-gray-600 hover:bg-gray-50'
              }`}
            >
            ...
            <button 
              ...
              className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors ${
                activeSection === 'guardians' ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-500' : 'text-gray-600 hover:bg-gray-50'
              }`}
            >
            ...
            <button 
              ...
              className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors ${
                activeSection === 'prescriptions' ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-500' : 'text-gray-600 hover:bg-gray-50'
              }`}
            >
            ...
            <button 
              ...
              className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors ${
                activeSection === 'meals' ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-500' : 'text-gray-600 hover:bg-gray-50'
              }`}
            >
            ...
            <button 
              ...
              className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors ${
                activeSection === 'conflicts' ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-500' : 'text-gray-600 hover:bg-gray-50'
              }`}
            >
            ...
            <button 
              ...
              className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors ${
                activeSection === 'doctors' ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-500' : 'text-gray-600 hover:bg-gray-50'
              }`}
            >
            ...
            <button 
              ...
              className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors ${
                activeSection === 'alerts' ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-500' : 'text-gray-600 hover:bg-gray-50'
              }`}
            >
              ...
              {!sidebarCollapsed && (
                <div className="flex items-center justify-between w-full">
                  ...
                  <span className="bg-orange-500 text-white text-xs px-2 py-1 rounded-full">12</span>
                </div>
              )}
            </button>
      ...
      {/* Right Panel */}
      <div className="w-[300px] bg-white border-l border-gray-200 shadow-lg flex flex-col flex-shrink-0">
        <div className="p-6 flex-1">
          <h3 className="text-lg font-semibold text-gray-800 mb-6">Quick Stats & Notifications</h3>
          
          {/* Quick Stats */}
          <div className="space-y-3 mb-6">
            <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl p-3 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs text-blue-100">System Health</p>
            ...
            <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-xl p-3 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs text-green-100">AI Accuracy</p>
            ...
            <div className="bg-gradient-to-r from-purple-500 to-purple-600 rounded-xl p-3 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs text-purple-100">Response Time</p>
          ...
          <div className="mb-6">
            ...
            <div className="space-y-3 max-h-48 overflow-y-auto">
              {alerts.length > 0 ? alerts.slice(0, 4).map((alert) => (
                <div key={alert.id} className={`flex items-start space-x-3 p-3 rounded-lg border hover:shadow-sm transition-shadow ${
          ...
          <div className="mt-auto">
            ...
            <div className="space-y-2">
              <button className="w-full flex items-center space-x-3 p-3 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors text-left">
                ...
                <span className="text-sm text-blue-800">Export Reports</span>
              </button>
              <button className="w-full flex items-center space-x-3 p-3 bg-green-50 hover:bg-green-100 rounded-lg transition-colors text-left">
                ...
                <span className="text-sm text-green-800">Refresh Data</span>
              </button>
              <button className="w-full flex items-center space-x-3 p-3 bg-purple-50 hover:bg-purple-100 rounded-lg transition-colors text-left">
                ...
                <span className="text-sm text-purple-800">System Settings</span>
              </button>
            </div>
          </div>
        </div>
